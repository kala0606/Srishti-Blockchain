...
class SrishtiApp {
        ...
        try {
            ...
            if (blocks.length > 0) {
                ...
                console.log('🔍 [App.init] State after loading:', {
                    ...
                    karmaBalances: Object.keys(this.chain.state.karmaBalances || {}).length
                });
                // State is automatically rebuilt during replaceChain via processTransactions
                // Karma balances are recalculated from blockchain transactions
            } else {
    ...
    /**
     * Recalculate karma balances from all blockchain transactions
    ...
    async recalculateKarmaBalances() {
        ...
        return await this.chain.recalculateKarmaBalances();
    }
    ...
    async validateKarmaBalances() {
        ...
        return await this.chain.validateKarmaBalances();
    }
